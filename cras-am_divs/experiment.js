...
function ready() {
	...
	if (i == (Math.floor(cra_examples.length/2)))
	{
		...
		document.getElementById("canvas").innerHTML="You may take a break, <br /> press the spacebar to continue";
	...
	else if (i < cra_examples.length)
	{
		...
		document.getElementById("canvas").innerHTML = "";
		document.getElementById("canvas").innerHTML="Ready?";
		// ctx.clearRect(0,0, WIDTH, HEIGHT);
  	...
  	else 
    {
    	...
    	document.getElementById("canvas").innerHTML = "";
		document.getElementById("canvas").innerHTML="Experiment Complete";
    }
...
function problem () {
	...
	document.getElementById("canvas").innerHTML = cra_examples[i].firstWord +  "<br />" 
							+ cra_examples[i].secondWord + "<br />"
							+ cra_examples[i].thirdWord;
...
function solution (){
	...
	document.getElementById("canvas").innerHTML = "";
	document.getElementById("canvas").innerHTML="Solution?";
...
function IorA (){
	...
	document.getElementById("canvas").innerHTML = "";
	document.getElementById("canvas").innerHTML="Insight or Analysis?";
